...
public class PacienteDAO extends ConexaoDB {
    ...
    private static final String SELECT_ALL_PACIENTE_SQL = "SELECT * FROM pacientes;";
    ...
    public Paciente selectPaciente(int id){
        ...
        try (PreparedStatement preparedStatement = prepararSQL(SELECT_PACIENTE_BY_ID)) {
            ...
            while (rs.next()) {
                ...
                entidade = new Paciente(nome, cpf, dt_nascimento);
            }
        } catch (SQLException e) {
            printSQLException(e);
        } catch (ClassNotFoundException e) {
    ...
    public boolean updateMedico(Paciente entidade) throws SQLException {
